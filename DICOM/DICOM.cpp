...
void CDICOMApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CDICOMApp customization load/save methods

void CDICOMApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CDICOMApp::LoadCustomState()
{
}

void CDICOMApp::SaveCustomState()
{
}
